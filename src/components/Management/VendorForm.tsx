      ...
      <div className="flex gap-4 my-6">
        ...
        <div className="w-[35%]">
          <div className="languages border border-[#F0F0F0] px-4 py-4 rounded-md  font-poppins">
            <div className="text-[#181818] text-lg font-semibold mb-4">
              List of Vendors
            </div>

            <div className="generate-login">
              <div className="flex flex-wrap gap-4 mt-6 mb-2">
                <div className="item w-[47%] flex items-center">
                  <img src="/icons/amazon.svg" alt="" className="mr-2" />
            ...
            <div className="generate-login">
              <div className="facility mt-6">
                ...
                <CustomSelect
                  ...
                  placeholder="eBay, Amazon & Daraz .etc"
                  className="mt-2"
                />
              </div>
              <div className="facility mt-3">
                ...
                <CustomSelect
                  ...
                  value={selectedValue}
                  onChange={setSelectedValue}
                  placeholder="facility, team, group & station .etc"
                  className="mt-2"
                />
              </div>
              <div className="facility mt-3">
